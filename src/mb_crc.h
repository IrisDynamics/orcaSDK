 ...
 */
 class ModbusCRC {
	...
	static inline constexpr uint8_t crc_table_hi_renamed[256] = {
	...
	static inline constexpr uint8_t crc_table_lo_renamed[256] = {
...
public:
	...
	static constexpr uint16_t generate(uint8_t *message, int message_len) {
		...
		while(message_len--) {
			...
			crc_hi_byte = crc_lo_byte ^ crc_table_hi_renamed[index];
			crc_lo_byte = crc_table_lo_renamed[index];
